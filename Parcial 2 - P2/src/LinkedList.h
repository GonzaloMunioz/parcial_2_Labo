...
/// Recorre la lista y la mapea, aplicando la funcion que recibe como parametro a cada elemento, y luego crea una nueva lista con los elementos ya modificados
